...
save scheduling, quarantine, or recovery guarantees.
...
- iOS work is paused for rollout focus. On resumption, the accepted #241
  readiness implementation precedes later iOS composition;
