...
use workspace_restore::{
    create_rollback_backup_in, read_workspace_restore_source_bytes, restore_workspace_backup_in,
};
...
use secure_fs::{
    ...
    open_workspace_lock, regular_file_exists, rename_workspace_path_in,
    require_new_regular_file_path, unlink_workspace_path, verify_opened_regular_file,
